#### Master Script 22a: Assess model performance ####
#
...
def main(array_task_id):
    ...
    overall_metrics.to_csv(os.path.join(metric_dir,'performance_overall_metrics_set_'+curr_set+'.csv'),index=False)
    ...
    thresh_level_metrics.to_csv(os.path.join(metric_dir,'performance_threshold_metrics_set_'+curr_set+'.csv'),index=False)
