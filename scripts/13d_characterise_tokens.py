#### Master Script 13d: Characterise token set to determine ideal end times for model training ####
#
...
curr_adm_vocab_df.ICUIntervention[curr_adm_vocab_df.BaseToken=='TimeFromAdmOrDisch'] = False
curr_adm_vocab_df.ClinicianInput[curr_adm_vocab_df.BaseToken=='TimeFromAdmOrDisch'] = False
curr_adm_vocab_df.Type[curr_adm_vocab_df.BaseToken=='TimeFromAdmOrDisch'] = 'Time from admission/discharge'

curr_disch_vocab_df.ICUIntervention[curr_disch_vocab_df.BaseToken=='TimeFromAdmOrDisch'] = False
curr_disch_vocab_df.ClinicianInput[curr_disch_vocab_df.BaseToken=='TimeFromAdmOrDisch'] = False
curr_disch_vocab_df.Type[curr_disch_vocab_df.BaseToken=='TimeFromAdmOrDisch'] = 'Time from admission/discharge'

# Fix information for added stop indicators on interval variables
curr_adm_vocab_df.ICUIntervention[curr_adm_vocab_df.Type.isna()] = True
curr_adm_vocab_df.ClinicianInput[curr_adm_vocab_df.Type.isna()] = False

curr_adm_vocab_df.Type[(curr_adm_vocab_df.Token == 'MedicationStop_1')|(curr_adm_vocab_df.Token == 'DVTProphylaxisStop_1')] = 'Medications'
curr_adm_vocab_df.Type[(curr_adm_vocab_df.Token == 'SurgeryCranialStop_1')|(curr_adm_vocab_df.Token == 'SurgeryExtraCranialStop_1')] = 'Surgery'
curr_adm_vocab_df.Type[curr_adm_vocab_df.Type.isna()] = 'ICU Monitoring and Management'
