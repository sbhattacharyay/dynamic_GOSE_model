#### Master Script 10a: Retrain dynamic all-predictor-based models to combat overfitting ####
#
...
# tuning_grid = tuning_grid[['tune_idx','RNN_TYPE','LATENT_DIM','EMBED_DROPOUT','HIDDEN_DIM','RNN_LAYERS','NUM_EPOCHS','ES_PATIENCE','IMBALANCE_CORRECTION','OUTPUT_ACTIVATION','LEARNING_RATE','BATCH_SIZE','repeat','fold','adm_or_disch']].reset_index(drop=True)
