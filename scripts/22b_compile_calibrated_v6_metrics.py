#### Master Script 22b: Compile performance metrics and calculate confidence intervals ####
#
...
metric_info_df = pd.DataFrame({'file':metric_files,
                               ...
                               'SET':[re.search('_set_(.*).csv', curr_file).group(1) for curr_file in metric_files]
