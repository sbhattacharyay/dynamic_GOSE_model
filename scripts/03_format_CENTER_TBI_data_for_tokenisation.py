#### Master Script 3: Format CENTER-TBI data for tokenisation ####
#
...
categorical_baseline_predictors[concat_cols] = categorical_baseline_predictors[concat_cols].fillna('NAN').apply(lambda x: 'Baseline' + x.name + '_' + x)
