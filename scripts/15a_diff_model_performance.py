#### Master Script 15a: Assess model performance ####
#
...
tuning_grid = tuning_grid[['tune_idx','WINDOW_LIMIT','BATCH_SIZE']].drop_duplicates()
tuning_grid['key'] = 1
bs_resamples['key'] = 1
rs_model_combos = pd.merge(bs_resamples,tuning_grid,how='outer',on='key').drop(columns='key')
