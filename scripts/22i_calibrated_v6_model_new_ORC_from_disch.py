#### Master Script 22i: Calculate new ORC metric from discharge ####
#
...
def main(array_task_id):
    ...
    orcs.to_csv(os.path.join(metric_dir,'performance_set_'+curr_set+'_new_orc_from_disch.csv'),index=False)
