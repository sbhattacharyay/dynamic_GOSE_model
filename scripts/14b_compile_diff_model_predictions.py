#### Master Script 14b: Compile predictions of dynamic all-predictor-based models ####
#
...
val_info_df = pred_file_info_df[pred_file_info_df.test_or_val == 'val'].reset_index(drop=True)
test_info_df = pred_file_info_df[pred_file_info_df.test_or_val == 'test'].reset_index(drop=True)
